...
def run_test(option: str, timeout: Union[int, None] = None) -> Union[Traceback, None]:
...
def exec_command_with_timeout(command: List[str], seconds: int) -> Union[str, None]:
...
if __name__ == "__main__":
    ...
    shutil.copytree(PATH_TO_QUIX_REPO +
                    "/static_python_programs", python_programs_path)
