...
def test_solve_knapsack_problem():
    assert solve_knapsack_problem(items, capacity).items == items
    assert solve_knapsack_problem(items, capacity).capacity == capacity
    assert solve_knapsack_problem(items, capacity).selected == items[:capacity]
