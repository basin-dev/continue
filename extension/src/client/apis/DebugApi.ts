...
export class DebugApi extends runtime.BaseAPI {
     ...
     * Explain
     */
    async explainDebugExplainPostRaw(requestParameters: ExplainDebugExplainPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.serializedDebugContext === null || requestParameters.serializedDebugContext === undefined) {
     ...
     * Explain
     */
    async explainDebugExplainPost(requestParameters: ExplainDebugExplainPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Inline
     */
    async inlineDebugInlinePostRaw(requestParameters: InlineDebugInlinePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Inline
     */
    async inlineDebugInlinePost(requestParameters: InlineDebugInlinePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Listten
     */
    async listtenDebugListPostRaw(requestParameters: ListtenDebugListPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.serializedDebugContext === null || requestParameters.serializedDebugContext === undefined) {
     ...
     * Listten
     */
    async listtenDebugListPost(requestParameters: ListtenDebugListPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Suggestion
     */
    async suggestionDebugSuggestionGetRaw(requestParameters: SuggestionDebugSuggestionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Suggestion
     */
    async suggestionDebugSuggestionGet(requestParameters: SuggestionDebugSuggestionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
