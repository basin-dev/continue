  ...
  suite("PythonTracebackSnooper", () => {
    test("should detect traceback given all at once", async () => {
      let traceback = `Traceback (most recent call last):
              File "/Users/natesesti/Desktop/basin/continue/extension/examples/python/main.py", line 10, in <module>
                sum(first, second)
              File "/Users/natesesti/Desktop/basin/continue/extension/examples/python/sum.py", line 2, in sum
                return a + b
